...
<body class="page-wrapper">
    ...
    <div class="hero-section">
        <div class="container">
            ...
            <p class="lead">Découvrez le monde avec style • Réservez en toute confiance</p>
            <div class="hero-buttons">
                <a href="${pageContext.request.contextPath}/search/flights" class="btn btn-highlight btn-lg">
                    <i class="fas fa-plane"></i> Réserver un vol
                </a>
                <a href="${pageContext.request.contextPath}/search/hotels" class="btn btn-glass btn-lg">
    ...
    <div class="container">
        <div class="search-form-container">
            <h3>
                <i class="fas fa-search"></i> Recherchez votre prochain voyage
            </h3>
            <form id="searchForm" action="${pageContext.request.contextPath}/search" method="GET">
                <div class="form-row">
                    <div>
                        <label for="searchType" class="form-label"><i class="fas fa-filter"></i> Type de voyage</label>
                        <select class="form-select" id="searchType" name="type" required>
                            <option value="flight"><i class="fas fa-plane-departure"></i> Vol</option>
                            <option value="hotel"><i class="fas fa-hotel"></i> Hôtel</option>
                            <option value="circuit"><i class="fas fa-map"></i> Circuit</option>
                        </select>
                    </div>
                    <div>
                        <label for="destination" class="form-label"><i class="fas fa-map-marker-alt"></i> Destination</label>
                        <input type="text" class="form-control" id="destination" name="destination" 
                               placeholder="Ex: Paris, Tokyo..." required>
                    </div>
                    <div>
                        <label for="departureDate" class="form-label"><i class="fas fa-calendar-alt"></i> Départ</label>
                        <input type="date" class="form-control" id="departureDate" name="departureDate">
                    </div>
                    <div>
                        <label for="returnDate" class="form-label"><i class="fas fa-calendar-check"></i> Retour</label>
    ...
    <div class="container">
        <div class="section-header">
            <h2><i class="fas fa-star" style="color: var(--vc-yellow);"></i> Pourquoi VoyageConnect ?</h2>
            <p>Votre agence de voyage de confiance</p>
        </div>
        <div class="features-grid">
            <div class="card glass-card">
                <div class="feature-icon" style="color: var(--vc-accent);">
                    <i class="fas fa-globe-americas"></i>
                </div>
                <h4>Destinations variées</h4>
                <p>Des centaines de destinations dans le monde entier pour tous les budgets et envies</p>
            </div>
            <div class="card glass-card">
                <div class="feature-icon" style="color: var(--vc-yellow);">
                    <i class="fas fa-tags"></i>
                </div>
                <h4>Meilleurs prix garantis</h4>
                <p>Profitez de nos offres exclusives et de nos promotions régulières toute l'année</p>
            </div>
            <div class="card glass-card">
                <div class="feature-icon" style="color: var(--vc-success);">
                    <i class="fas fa-shield-alt"></i>
                </div>
                <h4>Réservation 100% sécurisée</h4>
                <p>Paiement entièrement sécurisé et service client disponible 24h/24, 7j/7</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="section-header">
            <h2><i class="fas fa-fire" style="color: var(--vc-yellow);"></i> Destinations populaires</h2>
            <p>Explorez nos destinations les plus prisées</p>
        </div>
        <div class="destinations-grid">
            <div class="card glass-card destination-card">
                <img src="https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&h=400&fit=crop" alt="Paris">
                <div class="card-body">
                    <h5>
                        <i class="fas fa-map-marker-alt" style="color: var(--vc-yellow);"></i> Paris, France
                    </h5>
                    <p>La ville lumière et ses monuments emblématiques</p>
                    <div class="result-price">À partir de 299€</div>
                    <a href="${pageContext.request.contextPath}/search/flights?destination=Paris" 
                       class="btn btn-highlight btn-sm btn-block">
            ...
            <div class="card glass-card destination-card">
                ...
                <div class="card-body">
                    <h5>
                        <i class="fas fa-map-marker-alt" style="color: var(--vc-yellow);"></i> Tokyo, Japon
                    </h5>
                    <p>L'harmonie parfaite entre tradition et modernité</p>
                    <div class="result-price">À partir de 749€</div>
                    <a href="${pageContext.request.contextPath}/search/flights?destination=Tokyo" 
                       class="btn btn-highlight btn-sm btn-block">
                        <i class="fas fa-plane"></i> Réserver
                    </a>
                </div>
            ...
            <div class="card glass-card destination-card">
                <img src="https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=600&h=400&fit=crop" alt="New York">
                <div class="card-body">
                    <h5>
                        <i class="fas fa-map-marker-alt" style="color: var(--vc-yellow);"></i> New York, USA
                    </h5>
                    <p>La ville qui ne dort jamais vous attend</p>
                    <div class="result-price">À partir de 599€</div>
                    <a href="${pageContext.request.contextPath}/search/flights?destination=New York" 
                       class="btn btn-highlight btn-sm btn-block">
                        <i class="fas fa-plane"></i> Réserver
                    </a>
                </div>
            ...
            <div class="card glass-card destination-card">
                <img src="https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600&h=400&fit=crop" alt="Dubai">
                <div class="card-body">
                    <h5>
                        <i class="fas fa-map-marker-alt" style="color: var(--vc-yellow);"></i> Dubai, UAE
                    </h5>
                    <p>Luxe, démesure et architectures futuristes</p>
                    <div class="result-price">À partir de 499€</div>
                    <a href="${pageContext.request.contextPath}/search/flights?destination=Dubai" 
                       class="btn btn-highlight btn-sm btn-block">
                        <i class="fas fa-plane"></i> Réserver
                    </a>
                </div>
    ...
    <div class="container" style="margin: 4rem auto;">
        <div class="card card-highlight" style="padding: 3rem; text-align: center;">
            <h2 style="color: #ffffff; margin-bottom: 1rem;">
                <i class="fas fa-rocket"></i> Prêt pour l'aventure ?
            </h2>
            <p style="color: rgba(255, 255, 255, 0.9); font-size: 1.2rem; margin-bottom: 2rem;">
                Inscrivez-vous aujourd'hui et bénéficiez de 10% de réduction sur votre première réservation
            </p>
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <a href="${pageContext.request.contextPath}/auth/register" class="btn btn-highlight btn-lg">
                    <i class="fas fa-user-plus"></i> S'inscrire maintenant
                </a>
                <a href="${pageContext.request.contextPath}/search" class="btn btn-glass btn-lg">
