...
<head>
    ...
    <title>Gestion des Vols - VoyageConnect Admin</title>
...
.nav-link:hover {
    ...
    background: var(--vc-border-light);
        ...
        .route-display i { color: var(--vc-accent); }
        ...
        .seats-low { background: #fef3c7; color: #a16207; }
        ...
        .class-ECONOMY { background: #e5e7eb; color: #374151; }
        .class-BUSINESS { background: #dbeafe; color: #1d4ed8; }
        .class-FIRST_CLASS { background: #fef3c7; color: #92400e; }
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <div class="page-header-content">
                <div>
                    <h1><i class="fas fa-plane"></i> Gestion des Vols</h1>
                    <p class="subtitle">Ajoutez et gérez les vols disponibles sur la plateforme</p>
                </div>
    ...
    <div class="container">
        ...
        <div class="stats-row">
            <div class="stat-mini">
                <div class="stat-mini-value">${flights != null ? flights.size() : 0}</div>
                <div class="stat-mini-label">Total Vols</div>
            </div>
            <div class="stat-mini">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-hashtag"></i> Numéro de vol <span class="required">*</span>
                            </label>
                            <input type="text" name="flightNumber" class="form-control" placeholder="Ex: VY1234" required>
                        </div>

                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-building"></i> Compagnie aérienne <span class="required">*</span>
                            </label>
                            <input type="text" name="airline" class="form-control" placeholder="Ex: Royal Air Maroc" required>
                        </div>

                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-plane-departure"></i> Ville de départ <span class="required">*</span>
                            </label>
                            <input type="text" name="departureCity" class="form-control" placeholder="Ex: Casablanca" required>
                        </div>

                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-plane-arrival"></i> Destination <span class="required">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-calendar"></i> Date de départ <span class="required">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-calendar-check"></i> Date d'arrivée <span class="required">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control" placeholder="1500" min="0" step="0.01" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="totalSeats" class="form-control" placeholder="180" min="1" required>
                        </div>

                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-chair"></i> Classe <span class="required">*</span>
                            </label>
                            <select name="flightClass" class="form-control" required>
        ...
        <div class="admin-card">
            <div class="card-header">
                <h2><i class="fas fa-list"></i> Liste des vols</h2>
            </div>
            <div class="card-body">
                <c:choose>
                                    ...
                                    <c:forEach items="${flights}" var="flight">
                                        <tr>
                                            ...
                                            <td style="font-size: 0.8rem;">
                                                <fmt:parseDate value="${flight.departureDate}" pattern="yyyy-MM-dd'T'HH:mm" var="depDate" type="both"/>
                                                <fmt:formatDate value="${depDate}" pattern="dd/MM/yyyy HH:mm"/>
                                            </td>
                                            <td style="font-size: 0.8rem;">
                                                <fmt:parseDate value="${flight.arrivalDate}" pattern="yyyy-MM-dd'T'HH:mm" var="arrDate" type="both"/>
                                                <fmt:formatDate value="${arrDate}" pattern="dd/MM/yyyy HH:mm"/>
                                            </td>
                                            <td>
                                                <span class="class-badge class-${flight.flightClass}">${flight.flightClass}</span>
                                            </td>
                                            <td>
                                                <span class="price-tag">
                                                    <fmt:formatNumber value="${flight.price}" type="number" maxFractionDigits="0"/> MAD
                                                </span>
                                            </td>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${flight.availableSeats > 20}">
                                                        <span class="seats-badge seats-ok">${flight.availableSeats}/${flight.totalSeats}</span>
                                                    </c:when>
                                                    <c:when test="${flight.availableSeats > 0}">
                                                        <span class="seats-badge seats-low">${flight.availableSeats}/${flight.totalSeats}</span>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <span class="seats-badge seats-full">Complet</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                            <td>
                                                <div class="action-buttons">
                                                    <button class="btn btn-warning btn-sm" onclick="editFlight('${flight.id}')">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <form action="${pageContext.request.contextPath}/admin/flights" method="post" style="display: inline;" onsubmit="return confirm('Supprimer ce vol ?');">
