    ...
    <div class="container">
        ...
        <div class="filters-section">
            ...
            <div class="filter-chips">
                <a href="${pageContext.request.contextPath}/reservation/list" class="filter-chip ${empty param.status ? 'active' : ''}">
                    <i class="fas fa-list"></i> Toutes
                </a>
                <a href="${pageContext.request.contextPath}/reservation/list?status=CONFIRMEE" class="filter-chip ${param.status == 'CONFIRMEE' ? 'active' : ''}">
                    <i class="fas fa-check-circle"></i> Confirmées
                </a>
                <a href="${pageContext.request.contextPath}/reservation/list?status=EN_ATTENTE" class="filter-chip ${param.status == 'EN_ATTENTE' ? 'active' : ''}">
                    <i class="fas fa-clock"></i> En attente
                </a>
                <a href="${pageContext.request.contextPath}/reservation/list?status=ANNULEE" class="filter-chip ${param.status == 'ANNULEE' ? 'active' : ''}">
        ...
        <c:choose>
            <c:when test="${empty reservations}">
                <div class="empty-state">
                    ...
                    <p>Vous n'avez pas encore de réservation. Commencez à planifier votre prochain voyage !</p>
                    <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                        ...
                        <a href="${pageContext.request.contextPath}/search/hotels" class="btn btn-outline-primary">
                        ...
                        <div class="reservation-card">
                            ...
                            <div class="reservation-header">
                                <div class="reservation-left">
                                    <!-- Icon -->
                                    <div class="reservation-icon-box 
                                        <c:choose>
                                            <c:when test="${reservation.type == 'FLIGHT'}">icon-flight</c:when>
                                            <c:when test="${reservation.type == 'HOTEL'}">icon-hotel</c:when>
                                            <c:when test="${reservation.type == 'CIRCUIT'}">icon-circuit</c:when>
                                        </c:choose>">
                                        <c:choose>
                                    ...
                                    <div class="reservation-info">
                                        ...
                                        <div class="reservation-meta">
                                            <span class="meta-item">
                                                ...
                                                ${reservation.createdAt.format(DateTimeFormatter.ofPattern('dd/MM/yyyy'))}
                                            </span>
                                            <span class="meta-item">
                                ...
                                <div class="reservation-status">
                                    <span class="status-badge 
                                        <c:choose>
                                            <c:when test="${reservation.status == 'CONFIRMEE'}">status-confirmed</c:when>
                                            <c:when test="${reservation.status == 'EN_ATTENTE'}">status-pending</c:when>
                                            <c:when test="${reservation.status == 'ANNULEE'}">status-cancelled</c:when>
                                        </c:choose>">
                                        <c:choose>
                                    ...
                                    <c:if test="${reservation.payment != null}">
                                        <div class="reservation-price">
                                            <fmt:formatNumber value="${reservation.payment.amount}" pattern="#,##0.00" /> €
                                        </div>
                                    </c:if>
                                </div>
                            </div>
                                ...
                                <div class="details-grid">
                                    <c:if test="${reservation.flight != null}">
                                        <div class="detail-item">
                                            <span class="detail-label">
                                                <i class="fas fa-plane-departure"></i> Vol
                                            </span>
                                            <span class="detail-value">${reservation.flight.flightNumber}</span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">
                                                <i class="fas fa-map-marker-alt"></i> Destination
                                            </span>
                                            <span class="detail-value">${reservation.flight.destination.name}</span>
                                        </div>
                                    </c:if>
                                    
                                    <c:if test="${reservation.hotel != null}">
                                        <div class="detail-item">
                                            <span class="detail-label">
                                                <i class="fas fa-hotel"></i> Hôtel
                                            </span>
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <span class="detail-value">${reservation.hotel.destination.name}</span>
                                        </div>
                                    </c:if>
                                    
                                    <c:if test="${reservation.circuit != null}">
                                        <div class="detail-item">
                                            <span class="detail-label">
                                                <i class="fas fa-route"></i> Circuit
                                            </span>
                                            <span class="detail-value">${reservation.circuit.name}</span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">
                                                <i class="fas fa-calendar-days"></i> Durée
                                            </span>
                                    ...
                                    <c:if test="${reservation.payment != null}">
                                        <div class="detail-item">
                                            ...
                                            <span class="detail-value">${reservation.payment.paymentMethod}</span>
                                        </div>
                                    </c:if>
                                </div>
                            </div>
                            ...
                            <div class="reservation-actions">
                                <a href="${pageContext.request.contextPath}/reservation/view?id=${reservation.id}" class="btn btn-outline-primary btn-action">
                                    <i class="fas fa-eye"></i> Détails
                                </a>
                                <c:if test="${reservation.status == 'CONFIRMEE'}">
