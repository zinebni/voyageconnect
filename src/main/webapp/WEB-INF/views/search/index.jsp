...
<body class="page-wrapper">
    ...
    <div class="page-header">
        <div class="container">
            <h1>
                <i class="fas fa-search"></i> Recherche de Voyages
            </h1>
            <p class="lead-text">Explorez le monde à votre façon</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="section-header">
            <h2>
                <i class="fas fa-compass" style="color: var(--vc-accent);"></i> 
                Que recherchez-vous ?
            </h2>
            <p>Choisissez votre type de voyage</p>
        </div>

        <div class="search-options">
            <div class="option-card card glass-card">
            ...
            <div class="option-card card glass-card">
                <div class="option-icon" style="color: var(--vc-success);">
                ...
                <a href="${pageContext.request.contextPath}/search/hotels" class="btn btn-highlight btn-block">
                    <i class="fas fa-search"></i> Rechercher des hôtels
                </a>
            </div>

            <div class="option-card card glass-card">
                <div class="option-icon" style="color: var(--vc-yellow);">
                ...
                <a href="${pageContext.request.contextPath}/search/circuits" class="btn btn-highlight btn-block">
                    <i class="fas fa-search"></i> Rechercher des circuits
                </a>
            </div>
        </div>
        ...
        <div class="section-header">
            <h2>
                <i class="fas fa-fire" style="color: var(--vc-yellow);"></i> 
                Destinations populaires
            </h2>
            <p>Les destinations les plus prisées par nos voyageurs</p>
        </div>
        ...
        <div class="destinations-grid">
            <c:forEach var="destination" items="${destinations}">
                <div class="card glass-card destination-card">
                    ...
                    <div class="card-body">
                        <h5>
                            <i class="fas fa-map-marker-alt" style="color: var(--vc-yellow);"></i> 
                            ${destination.name}
                        </h5>
                        ...
                        <a href="${pageContext.request.contextPath}/search/flights?destinationId=${destination.id}"
                           class="btn btn-highlight btn-sm btn-block">
                            <i class="fas fa-plane"></i> Explorer
                        </a>
                    </div>
                </div>
            </c:forEach>
        ...
        <div class="features-banner card card-highlight">
            <div class="features-banner-content">
                <div class="features-banner-icon">
                    <i class="fas fa-lightbulb"></i>
                </div>
                <div class="features-banner-text">
                    <h3>Besoin d'inspiration ?</h3>
                    <p>Consultez nos guides de voyage et découvrez les meilleures expériences</p>
                </div>
                <a href="${pageContext.request.contextPath}/guides" class="btn btn-glass btn-lg">
                    <i class="fas fa-book-open"></i> Voir les guides
                </a>
            </div>
        </div>
    </div>
