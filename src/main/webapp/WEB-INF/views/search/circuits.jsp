...
<body class="page-wrapper">
    ...
    <div class="page-header">
        <div class="container">
            <h1>
                <i class="fas fa-route"></i> Recherche de Circuits
            </h1>
            <p class="lead-text">Découvrez nos circuits organisés</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="search-form-container">
            <h3>
                <i class="fas fa-filter"></i> Trouvez votre circuit idéal
            </h3>
                ...
                <div class="form-row">
                    ...
                    <div>
                        <label for="minDuration" class="form-label">
                            <i class="fas fa-hourglass-start"></i> Durée min (jours)
                        </label>
                        <input type="number" name="minDuration" id="minDuration" class="form-control" 
                               value="${minDuration}" min="1" placeholder="Ex: 3">
                    </div>
                    <div>
                        <label for="maxDuration" class="form-label">
                            <i class="fas fa-hourglass-end"></i> Durée max (jours)
                        </label>
                        <input type="number" name="maxDuration" id="maxDuration" class="form-control" 
                               value="${maxDuration}" min="1" placeholder="Ex: 14">
                    </div>
                    <div>
                        ...
                        <input type="number" name="participants" id="participants" class="form-control" 
                               value="${participants}" min="1" placeholder="1">
                    </div>
                    <div>
        ...
        <div class="results-header">
            <h2>
                <i class="fas fa-map-signs"></i> Circuits disponibles
                <span class="results-count">(${circuits.size()})</span>
            </h2>
            <c:if test="${not empty circuits}">
                <div class="results-info">
                    <i class="fas fa-info-circle"></i> 
                    ${circuits.size()} circuit(s) trouvé(s)
                </div>
            </c:if>
        </div>
        ...
        <!-- Results -->
        <c:choose>
            <c:when test="${empty circuits}">
                <div class="empty-state">
                    <div class="empty-state-icon">
                        <i class="fas fa-route"></i>
                    </div>
                    <h3>Aucun circuit trouvé</h3>
                    <p>Essayez de modifier vos critères de recherche ou explorez d'autres destinations</p>
                    <a href="${pageContext.request.contextPath}/search/circuits" class="btn btn-highlight">
            ...
            <c:otherwise>
                <div class="circuits-grid">
                    <c:forEach var="circuit" items="${circuits}">
                        <div class="circuit-card card glass-card">
                            <!-- Circuit Image -->
                            <div class="circuit-image-container">
                                <div class="circuit-image-placeholder">
                                    <img src="${circuit.imageUrl}" alt="${circuit.name}">
                                </div>
                                <div class="circuit-duration-badge">
                                    <i class="fas fa-calendar-days"></i>
                                    ${circuit.durationDays} jours
                                </div>
                            </div>
                            ...
                            <div class="circuit-body">
                                <h3 class="circuit-title">
                                    <i class="fas fa-map"></i> ${circuit.name}
                                </h3>
                                <p class="circuit-location">
                                    <i class="fas fa-map-marker-alt"></i> 
                                    ${circuit.destination.name}, ${circuit.destination.country}
                                </p>
                                ...
                                <div class="circuit-info-grid">
                                    <div class="info-card">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <span class="info-value">${circuit.durationDays} jours</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-card">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <span class="info-value">${circuit.availableSpots}/${circuit.totalSpots}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-card info-card-wide">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <span class="info-value">
                                                <c:out value="${circuit.startDate.format(DateTimeFormatter.ofPattern('dd/MM/yyyy'))}" /> 
                                                <i class="fas fa-arrow-right"></i>
                                                <c:out value="${circuit.endDate.format(DateTimeFormatter.ofPattern('dd/MM/yyyy'))}" />
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="circuit-footer">
                                    <div class="circuit-availability">
                                        <c:choose>
                                            <c:when test="${circuit.availableSpots > 5}">
                                                <i class="fas fa-circle-check" style="color: var(--vc-success);"></i>
                                                <span style="color: var(--vc-success);">Bonne disponibilité</span>
                                            </c:when>
                                            <c:when test="${circuit.availableSpots > 0}">
                                                <i class="fas fa-circle-exclamation" style="color: var(--vc-yellow);"></i>
                                                <span style="color: var(--vc-yellow);">Places limitées</span>
                                            </c:when>
                                            <c:otherwise>
                                                <i class="fas fa-circle-xmark" style="color: var(--vc-danger);"></i>
                                                <span style="color: var(--vc-danger);">Complet</span>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    
                                    <div class="circuit-booking">
                                        <div class="circuit-price-section">
                                        ...
                                        <a href="${pageContext.request.contextPath}/reservation/new?type=circuit&id=${circuit.id}" 
                                           class="btn btn-highlight btn-block">
        ...
        <c:if test="${not empty circuits}">
            <div class="tips-section card card-highlight">
                <div class="tips-content">
                    ...
                    <div class="tips-text">
                        <h3>Voyagez l'esprit tranquille</h3>
                        <p>Tous nos circuits sont encadrés par des guides professionnels et incluent hébergement, transport et activités.</p>
                    </div>
                </div>
            </div>
        </c:if>
