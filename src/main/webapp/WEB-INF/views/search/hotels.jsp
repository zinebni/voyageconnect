...
<body class="page-wrapper">
    ...
    <div class="page-header">
        <div class="container">
            <h1>
                <i class="fas fa-hotel"></i> Recherche d'Hôtels
            </h1>
            <p class="lead-text">Trouvez l'hébergement parfait pour votre séjour</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="search-form-container">
            <h3>
                <i class="fas fa-filter"></i> Affinez votre recherche
            </h3>
            <form method="GET" action="${pageContext.request.contextPath}/search/hotels">
                <div class="form-row">
                    ...
                    <div>
                        <label for="minStars" class="form-label">
                            <i class="fas fa-star"></i> Étoiles min
                        </label>
                        <input type="number" name="minStars" id="minStars" class="form-control" 
                               value="${minStars}" min="1" max="5" placeholder="1-5">
                    </div>
                    <div>
                        ...
                        <input type="number" name="maxPrice" id="maxPrice" class="form-control" 
                               value="${maxPrice}" step="0.01" placeholder="Ex: 200">
                    </div>
                    <div>
        ...
        <div class="results-header">
            <h2>
                <i class="fas fa-building"></i> Hôtels disponibles
                <span class="results-count">(${hotels.size()})</span>
            </h2>
            <c:if test="${not empty hotels}">
                <div class="results-info">
                    <i class="fas fa-info-circle"></i> 
                    ${hotels.size()} hébergement(s) trouvé(s)
                </div>
            </c:if>
        </div>
        ...
        <c:choose>
            <c:when test="${empty hotels}">
                <div class="empty-state">
                    ...
                    <a href="${pageContext.request.contextPath}/search/hotels" class="btn btn-highlight">
            ...
            <c:otherwise>
                <div class="hotels-grid">
                    <c:forEach var="hotel" items="${hotels}">
                        <div class="hotel-card card glass-card">
                                ...
                                <div class="hotel-footer">
                                    <div class="hotel-availability">
                                        ...
                                        <span class="availability-text">
                                            <strong>${hotel.availableRooms}</strong> chambre(s) disponible(s)
                                        </span>
                                        <span class="availability-total">
                                            sur ${hotel.totalRooms}
                                        </span>
                                    </div>
            ...
            <div class="tips-section card card-highlight">
                <div class="tips-content">
                    ...
                    <div class="tips-text">
                        ...
                        <p>Réservez tôt pour bénéficier des meilleurs tarifs et d'une plus grande disponibilité !</p>
                    </div>
                </div>
            </div>
        </c:if>
