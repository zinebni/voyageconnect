...
<body class="page-wrapper">
    ...
    <div class="page-header">
        <div class="container">
            <h1>
                <i class="fas fa-globe-americas"></i> Nos Destinations
            </h1>
            <p class="lead-text">Explorez le monde avec VoyageConnect</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="destinations-intro">
            <p>
                ...
                Découvrez nos destinations soigneusement sélectionnées à travers le monde. 
                Que vous recherchiez l'aventure, la détente ou la découverte culturelle, 
                nous avons la destination parfaite pour vous.
            </p>
        </div>
        ...
        <div class="destinations-list-grid">
            <c:forEach var="destination" items="${destinations}">
                <div class="destination-list-card card glass-card">
                    <!-- Image Section -->
                    <div class="destination-image-wrapper">
                        <img src="${destination.imageUrl}" 
                             alt="${destination.name}" 
                             class="destination-image"
                             onerror="this.onerror=null; this.parentElement.innerHTML='<div class=\'destination-image-fallback\'><i class=\'fas fa-map-marked-alt\'></i><span>${destination.name}</span></div>';">
                    ...
                    <div class="destination-body">
                        ...
                        <div class="destination-actions">
                            <a href="${pageContext.request.contextPath}/search/flights?destinationId=${destination.id}" 
                               class="btn btn-highlight btn-action">
        ...
        <c:if test="${empty destinations}">
            <div class="empty-state">
                ...
                <p>Nous travaillons à ajouter de nouvelles destinations passionnantes pour vous !</p>
            ...
            <div class="cta-banner card card-highlight">
                <div class="cta-content">
                    ...
                    <div class="cta-text">
                        ...
                        <p>Notre équipe d'experts est là pour vous conseiller et créer un voyage sur mesure</p>
                    </div>
                    <a href="${pageContext.request.contextPath}/contact" class="btn btn-glass btn-lg">
