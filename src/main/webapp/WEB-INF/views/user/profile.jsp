        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="profile-card">
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            <th>
                                <i class="fas fa-calendar-plus"></i> Membre depuis
                            </th>
                    ...
                    <div class="profile-actions">
                        <a href="${pageContext.request.contextPath}/user/edit-profile" class="btn btn-highlight">
                            <i class="fas fa-edit"></i> Modifier mon profil
                        </a>
                        <a href="${pageContext.request.contextPath}/user/change-password" class="btn btn-outline-primary">
            ...
            <div class="col-md-4">
                ...
                <div class="quick-links-card">
                    ...
                    <a href="${pageContext.request.contextPath}/user/dashboard" class="quick-link">
                        <i class="fas fa-chart-line"></i>
                        <span>Tableau de bord</span>
                    </a>
                    
                    <a href="${pageContext.request.contextPath}/reservation/list" class="quick-link">
                        <i class="fas fa-list"></i>
                        <span>Mes réservations</span>
                    </a>
                    
                    <a href="${pageContext.request.contextPath}/search/flights" class="quick-link">
                        <i class="fas fa-plane"></i>
                        <span>Rechercher un vol</span>
                    </a>
                    
                    <a href="${pageContext.request.contextPath}/search/hotels" class="quick-link">
